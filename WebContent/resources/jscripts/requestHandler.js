	...
	for(var i=0; i < items.length; i++)	{		
		...
		var line= 
					"<div class='postingContainer' id='posting"+i+"'>" +
						...
						"<div class='middle-content-box-list-post' id='header-post'>" + "<a href='" + link + "'><p>" + title + "</p></a></div>" +
				     	"<p>"+description+"</p><br/>" +
				     	"<p>Posted by <a href='"+rootdir+"gotoUserPage?username="+username+"'>" + username+ "</a> on "+bookmarktime+" | "+bookmarkdate+"</p>" +
				     	"<div class='post'>" +
				     	"<a href='"+rootdir+"pickBookmark?title="+title+"&link="+link+"&description="+description+"' class='saveme'>Save</a>" +
						...
						"</div>" +
						"<div class ='tagEntry' id='tagEntry"+id+"'><p>Tag : "+tagEntry+"<p></div><br/>" +	
